...
function Categories() {
  ...
  const texts = {
    en: {
      ...
      englishClass: "Book English Class",
  ...
  return (
    <div className={`mt-10 mb-10 w-[95%] mx-auto p-6 rounded-lg relative overflow-hidden`} 
         style={{
          ...
          <div className="w-fit sm:w-96  p-8 rounded-xl transition duration-300 ease-in-out  overflow-hidden border-2 border-white">
            ...
            <div className="p-6 text-center">
              <button 
                ...
                className="w-full py-4 text-white font-bold text-xl rounded-lg bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 transition-transform transform shadow-md"
              >
          ...
          <div className="w-full sm:w-96  p-8 rounded-xl transition duration-300 ease-in-out transform overflow-hidden border-2 border-white">
            ...
            <div className="p-6 text-center">
              <button 
                ...
                className="w-full py-4 text-white font-bold text-xl rounded-lg bg-gradient-to-r from-blue-400 to-blue-600 hover:from-blue-500 hover:to-blue-700 transition-transform transform shadow-md"
              >
